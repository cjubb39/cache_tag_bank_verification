...
formal netlist constraint way_out_flush_ready 1'b1
formal netlist constraint set_out_flush_ready 1'b1
formal netlist constraint tag_out_flush_ready 1'b1
formal netlist constraint state_out_flush_ready 1'b1
formal netlist constraint inv_ack_cnt_out_flush_ready 1'b1
